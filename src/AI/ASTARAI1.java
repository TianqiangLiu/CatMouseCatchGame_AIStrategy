...
public class ASTARAI1 implements AI{
	...
	public ArrayList<Integer> getResult(Board board) {
		...
		BFSNode bfsNode = getAStar1ResultNode(board);
		if(bfsNode==null) {
			return null;
		}
	...
	public BFSNode getAStar1ResultNode(Board board){
	...
	public Integer heuristic1(BFSNode bfsNode) {
		...
		int distance = 0;
		distance = Math.abs(bfsNode.getCatEntry().get(0)-mousePath.get(bfsNode.getRoundInteger()).get(0))
